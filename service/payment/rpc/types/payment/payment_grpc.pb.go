...
func (c *paymentServiceClient) CancelPayment(ctx context.Context, in *CancelPaymentReq, opts ...grpc.CallOption) (*CancelPaymentResp, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
...
func (UnimplementedPaymentServiceServer) CancelPayment(context.Context, *CancelPaymentReq) (*CancelPaymentResp, error) {
...
var PaymentService_ServiceDesc = grpc.ServiceDesc{
	...
	Metadata: "payment/rpc/payment.proto",
}

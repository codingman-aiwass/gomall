...
var file_product_rpc_product_proto_rawDesc = []byte{
	...
	0x75, 0x6c, 0x74, 0x73, 0x32, 0xca, 0x03, 0x0a, 0x15, 0x50, 0x72, 0x6f, 0x64, 0x75, 0x63, 0x74,
	0x43, 0x61, 0x74, 0x61, 0x6c, 0x6f, 0x67, 0x53, 0x65, 0x72, 0x76, 0x69, 0x63, 0x65, 0x12, 0x48,
...
var file_product_rpc_product_proto_depIdxs = []int32{
	...
	0,  // 3: product.ProductCatalogService.CreateProduct:input_type -> product.CreateProductReq
	2,  // 4: product.ProductCatalogService.UpdateProduct:input_type -> product.UpdateProductReq
	4,  // 5: product.ProductCatalogService.DeleteProduct:input_type -> product.DeleteProductReq
	6,  // 6: product.ProductCatalogService.ListProducts:input_type -> product.ListProductsReq
	...
	1,  // 9: product.ProductCatalogService.CreateProduct:output_type -> product.CreateProductResp
	3,  // 10: product.ProductCatalogService.UpdateProduct:output_type -> product.UpdateProductResp
	5,  // 11: product.ProductCatalogService.DeleteProduct:output_type -> product.DeleteProductResp
